...
variable "managed_zone_name" {
  description = "The name of the managed DNS zone to place the Remote Monitor A record in."
  type        = string
}
...
variable "vpc_self_link" {
  ...
  default     = null
  validation {
    condition     = var.vpc_self_link != null || var.rm_firewall_tags != null
...
variable "rm_firewall_tags" {
  description = "(Optional) The set of firewall tags which should be applied to the Remote Monitor instance. If excluded, firewall rules will be created automatically."
  type        = set(string)
  default     = null
}

variable "rm_image" {
  description = "(Optional) The image used to initialise the Remote Monitor instance. This image must have the MULTI_IP_SUBNET guest os feature. If excluded, a new custom ubuntu image will be created. See https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_instance#image-1 for format"
  type        = string
  default     = null
}
