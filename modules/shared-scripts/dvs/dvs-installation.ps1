...
Write-Output "License DVS: `$DVSLicense"
Write-Output "DDM address: `$DDMAddress"
# Input validation
...
if (`$DDMAddress) {
    ...
    Write-Output "Static DDM reference. Device will appear under Unmanaged"
}
